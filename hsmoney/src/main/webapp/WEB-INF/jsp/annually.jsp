		...
		<hr class="divider" style="margin-top:0px; margin-bottom:15px;"></hr>
		 	...
		 	<div class="input-group mb-3"  style="padding-top: 10px;">
				  <div class="input-group-prepend">
					    <input type="text" value ="Annual Sum" class="input-group-text30" style="width:121px; text-align:left;" readonly> 
				  </div>
			...
			<div class="input-group mb-3 " >
			    <div class="input-group-prepend" >
					<select class="custom-select input-group-text29" id="anuall_select" name="anuall_select" style="width:121px;" onchange="yearSelect()" >
